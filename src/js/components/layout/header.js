                ...
                <nav>
                    <ul className="nav-menu" data-active={this.state.menuActive} data-current="Home">
                        <li className="nav-menu-li">
                            <Link to="/" className="nav-menu-a" href="">Home</Link>
                        </li>
                        <li className="nav-menu-li">
                            <Link to="/explore" className="nav-menu-a" href="">Explore</Link>
                        </li>
                        <li className="nav-menu-li" id="nav-menu-button" onClick={() => this.toggleMenu()}>
                            <img className="nav-menu-logo" src={logo} alt=""/>
                        </li>
                        <li className="nav-menu-li">
                            <Link to="/about" className="nav-menu-a" href="">About</Link>
                        </li>
                        <li className="nav-menu-li">
                            <Link to="/contact" className="nav-menu-a" href="">Contact</Link>
                        </li>
                    </ul>
                </nav>
                <div>Player</div>
